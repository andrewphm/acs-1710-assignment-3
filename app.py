...
def compliments_results():
    ...
    wants_compliments = bool(request.args.get("wants_compliments") == 'yes')
...
def animal_facts():
    ...
    if request.args.get('animal'):
        animal_fact = animal_to_fact[request.args.get('animal')]
    else:
        animal_fact = None
    ...
    context = {
        ...
        'animal_fact': animal_fact or None
    }
